# Requirements Archive: v1.0 Local-Only Security Foundation

**Archived:** 2026-04-29
**Status:** SHIPPED

*After archive, v1.0 requirements are closed. The next milestone introduces a new `.planning/REQUIREMENTS.md` via `/gsd-new-milestone`.*
